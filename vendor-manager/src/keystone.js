// vendor-manager/src/keystone.js
// Thin client for Keystone's POST /v1/generate — same pattern as Atrium's.
// Quarry never holds a provider API key; Keystone owns that.
